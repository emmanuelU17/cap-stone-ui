...
@Component({
  ...
  template: `
    <div class="lg-scr mg-top p-20 flex justify-center items-center">
      <form class="w-fit max-[768px]:w-full py-3 px-4 appearance-none shadow-md outline-none border-none block rounded-lg bg-[var(--white)]">
        ...
        <div class="w-full flex mt-2.5 justify-end">
          <button type="button"
                  ...
                  (click)="displayMessage = !displayMessage"
          >login</button>
        </div>
