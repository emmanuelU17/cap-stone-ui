...
@Component({
  ...
  template: `
    <form
      [formGroup]="form"
      class="w-full py-3 px-4 appearance-none shadow-md outline-none border-none block rounded-lg bg-[var(--white)]"
    >
      ...
      <div class="mt-2">
        <div class="mt-4 flex items-center justify-between">
          ...
          <a class="text-xs text-center text-gray-500 uppercase"
            >or login with</a
          >
          <span class="border-b w-1/5 lg:w-1/4"></span>
        </div>
        ...
        <div class="flex justify-between gap-4">
          ...
          >
            ...
            <h1 class="font-app-card text-center text-blue-400">
              Login with Google
            </h1>
          </button>
          ...
          <button
            type="button"
            (click)="displayRegister('register')"
