  ...
  template: `
    <div class="p-2 mb-2 md:p-4 md:mb-3 bg-neutral-100">
      ...
      <div class="grid grid-cols-3 sm:hidden">
        ...
        <a routerLink="/order/cart" routerLinkActive="active-r" [routerLinkActiveOptions]="{ exact: true }"
           class="text-center bg-white opacity-50 hover:bg-transparent hover:opacity-100">
          <div class="flex justify-center">
            <h1 class="cx-font-fam uppercase banner" style="font-size: calc(10px + 1vw)">01 cart</h1>
          </div>
        </a>

        <a routerLink="/order/checkout" routerLinkActive="active-r" [routerLinkActiveOptions]="{ exact: true }"
           class="text-center bg-white opacity-50 hover:bg-transparent hover:opacity-100">
          <div class="flex justify-center">
            <h1 class="cx-font-fam banner uppercase" style="font-size: calc(10px + 1vw);">02 checkout</h1>
          </div>
        </a>

        <a routerLink="/order" routerLinkActive="active-r" [routerLinkActiveOptions]="{ exact: true }"
           class="text-center bg-white opacity-50 hover:bg-transparent hover:opacity-100">
          <div class="flex justify-center">
            <h1 class="cx-font-fam banner uppercase" style="font-size: calc(10px + 1vw);">03 payment</h1>
          </div>
        </a>
      </div>
