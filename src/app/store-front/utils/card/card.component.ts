  ...
  template: `
    <div class="h-full w-full flex flex-col">
      <div class="aspect-h-1 aspect-w-1 w-full overflow-hidden rounded-md bg-gray-200 lg:aspect-none group-hover:opacity-75 h-36 sm:h-56 md:h-80">
        <img [src]="url" class="h-full w-full object-cover object-center lg:h-full lg:w-full" alt="product image">
      </div>
      <!-- End of Image Container -->
      <div class="mt-4 flex flex-col items-center md:flex-row md:justify-between">
