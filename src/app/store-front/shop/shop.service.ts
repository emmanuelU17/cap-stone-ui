...
export class ShopService {
  ...
  readonly currentCategorySubject = new BehaviorSubject<number | undefined>(
    undefined,
  );
  ...
  readonly allCategories = (): Observable<Category[]> =>
    this.http
      .get<
        Category[]
      >(`${this.HOST}api/v1/client/category`, { withCredentials: true })
