        ...
        @case ('LOADED') {
          <div class="lg-scr h-full flex flex-col overflow-x-hidden lg:m-auto">
            ...
            <div class="flex flex-1">
              ...
              >
                <div
                  *ngFor="let link of dashBoardLinks; let j = index"
                  class="w-52 py-0 px-2.5 max-[768px]:w-[calc(200px + 1vw)]"
                >
                  <div class="uppercase">
                    @if (j === 0) {
                      <div
                        class="w-fit flex gap-2.5 border-b border-[var(--app-theme)]"
                      >
                        <h3 class="cx-font-size capitalize">
                          {{ link.title }}
                        </h3>
                        ...
                        <div class="flex gap-1">
                          ...
                          <button
                            ...
                            [style]="{
                              'background-color':
                                activeCurrency === SarreCurrency.USD
                                  ? '#E8E8E8'
                                  : 'white'
                            }"
                          >
                  ...
                  <div class="py-2.5 px-0">
                    <ul
                      class="list-none"
                      *ngFor="let a of link.array; let i = index"
                    >
                      <li
                      ...
                      >
                        <a
                          [routerLink]="a.route"
                          class="w-full h-full p-2.5 flex items-center gap-1.5 capitalize cursor-pointer rounded-md"
                        >
              ...
              <div class="p-2.5 flex flex-col flex-1 overflow-x-auto">
                ...
                <div
                  class="sticky rounded-full w-fit bottom-2/4 bg-[var(--app-theme)] opacity-50 hover:opacity-100"
                >
                  <button
                    class="p-3 bg-[var(--in-active)]"
                    (click)="leftColumn = !leftColumn"
                  >
                    <svg
            ...
            <!--  Footer  -->
            <div
              class="p-3.5 items-end border-t-2 border-solid border-[var(--active)]"
            >
